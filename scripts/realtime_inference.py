...
if __name__ == "__main__":
    ...
    parser.add_argument("--unet_config", type=str, default=os.path.join(_model_dir, "musetalkV15", "musetalk.json"), help="Path to UNet configuration file")
    parser.add_argument("--unet_model_path", type=str, default=os.path.join(_model_dir, "musetalkV15", "unet.pth"), help="Path to UNet model weights")
    parser.add_argument("--whisper_dir", type=str, default=os.path.join(_model_dir, "whisper"), help="Directory containing Whisper model")
